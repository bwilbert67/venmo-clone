...
public class JdbcTransferDao  implements TransferDao{
    ...
    public List<Transfer> getAllTransfersByUserId(int userId) {
        ...
        String sql = "SELECT * FROM transfer JOIN account ON account.account_id = transfer.account_to OR account.account_id = transfer.account_from WHERE user_id = ?";
        ...
        while (rowSet.next()) {
            ...
            curTransfer.setTransferType(rowSet.getInt("transfer_type_id"));
            curTransfer.setTransferStatus(rowSet.getInt("transfer_status_id"));
            curTransfer.setAccountFrom(rowSet.getInt("account_from"));
    ...
    @Override
    public int updateTransfer(int id, int status) {
