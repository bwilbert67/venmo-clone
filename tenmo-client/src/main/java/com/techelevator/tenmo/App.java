...
public class App {
        ...
        while (menuSelection != 0) {
            ...
            if (menuSelection == 1) {
                ...
                if(transferId == 0) {
                    ...
                    int transferDecision = consoleService.promptForInt("Please choose an option: ");
                    if(transferDecision == 1 || transferDecision == 2) {
                        updateTransfer(transferId,transferDecision);
                    } else {
                        continue;
                    }
                }
	...
	private void viewPendingRequests() {
        ...
        for (Transfer cur : allTransfers) {
            if (cur.getTransferStatus() == 1)
            System.out.println(cur.getId() + "         " + cur.getAccountFrom() + "         " + cur.getAmount());
        }
	}
	...
	private void requestBucks(int requestUserId, BigDecimal amount) {
		// TODO Auto-generated method stub
        System.out.println("Transfer status:" + tenmoService.requestBucks(currentUser, requestUserId, amount));
	}
    ...
    private void updateTransfer(int transferId, int transferStatus) {
        System.out.println(tenmoService.updateTransfer(transferStatus, transferId, currentUser));
    }
